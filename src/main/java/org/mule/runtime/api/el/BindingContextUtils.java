...
public class BindingContextUtils {
  ...
  public static final String GROUP_CORRELATION = "groupCorrelation";
  ...
  public static BindingContext.Builder addEventBuindingsToBuilder(Event event, BindingContext baseContext) {
    ...
    contextBuilder.addBinding(CORRELATION_ID,
                              new LazyValue<>(() -> new TypedValue<>(event.getCorrelationId(), STRING)));

    contextBuilder.addBinding(GROUP_CORRELATION, new LazyValue<>(() -> new TypedValue(event.getGroupCorrelation(), fromType(GroupCorrelation.class))));
